...
function drawKeypad(canvasName, animationName, loop) {
  ...
  var duration = Number(animation.getDuration());
  duration = Math.max(duration, 0.033);
  if (canvasTimers.keypad[canvasName] != undefined) {
    clearTimeout(canvasTimers.keypad[canvasName]);
    canvasTimers.keypad[canvasName] = undefined;
  }
  let timer = setTimeout(function () {
    if (state.Loop == false) {
      if (!usingIdle &&
  ...
  canvasTimers.keypad[canvasName] = timer;
}
function drawChromaLink(canvasName, animationName, loop) {
  ...
  var duration = Number(animation.getDuration());
  duration = Math.max(duration, 0.033);
  if (canvasTimers.chromaLink[canvasName] != undefined) {
    clearTimeout(canvasTimers.chromaLink[canvasName]);
    canvasTimers.chromaLink[canvasName] = undefined;
  }
  let timer = setTimeout(function () {
    if (state.Loop == false) {
      if (!usingIdle &&
  ...
  canvasTimers.chromaLink[canvasName] = timer;
}
function drawHeadset(canvasName, animationName, loop) {
  ...
  var duration = Number(animation.getDuration());
  duration = Math.max(duration, 0.033);
  if (canvasTimers.headset[canvasName] != undefined) {
    clearTimeout(canvasTimers.headset[canvasName]);
    canvasTimers.headset[canvasName] = undefined;
  }
  let timer = setTimeout(function () {
    if (state.Loop == false) {
      if (!usingIdle &&
  ...
  canvasTimers.headset[canvasName] = timer;
}
function drawMouse(canvasName, animationName, loop) {
  ...
  var duration = Number(animation.getDuration());
  duration = Math.max(duration, 0.033);
  if (canvasTimers.mouse[canvasName] != undefined) {
    clearTimeout(canvasTimers.mouse[canvasName]);
    canvasTimers.mouse[canvasName] = undefined;
  }
  let timer = setTimeout(function () {
    if (state.Loop == false) {
      if (!usingIdle &&
  ...
  canvasTimers.mouse[canvasName] = timer;
}
function drawMousepad(canvasName, animationName, loop) {
  ...
  var duration = Number(animation.getDuration());
  duration = Math.max(duration, 0.033);
  if (canvasTimers.mousepad[canvasName] != undefined) {
    clearTimeout(canvasTimers.mousepad[canvasName]);
    canvasTimers.mousepad[canvasName] = undefined;
  }
  let timer = setTimeout(function () {
    if (state.Loop == false) {
      if (!usingIdle &&
  ...
  canvasTimers.mousepad[canvasName] = timer;
}
...
var stopAllCanvasTimers = function () {
  for (var element in canvasTimers.chromaLink) {
    clearTimeout(canvasTimers.chromaLink[element]);
  };
  canvasTimers.chromaLink = [];

  for (var element in canvasTimers.headset) {
    clearTimeout(canvasTimers.headset[element]);
  };
  canvasTimers.headset = [];
  ...
  for (var element in canvasTimers.keypad) {
    clearTimeout(canvasTimers.keypad[element]);
  };
  canvasTimers.keypad = [];

  for (var element in canvasTimers.mouse) {
    clearTimeout(canvasTimers.mouse[element]);
  };
  canvasTimers.mouse = [];

  for (var element in canvasTimers.mousepad) {
    clearTimeout(canvasTimers.mousepad[element]);
  };
  canvasTimers.mousepad = [];
}
